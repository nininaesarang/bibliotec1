# BiblioTec - Sistema de Gestión de Inventarios Web

Sistema integral diseñado para centralizar y optimizar el control de registros, orientado a la digitalización de procesos administrativos.

## ⚡ Tecnologías Utilizadas
* **Frontend:** HTML5, CSS3 y JavaScript para una interfaz intuitiva y dinámica.
* **Backend:** PHP para la lógica de servidor y procesamiento de datos.
* **Base de Datos:** SQL (MySQL/phpMyAdmin) con arquitectura relacional para garantizar la integridad de la información.
* **Control de Versiones:** Git y GitHub.

## 🚀 Funcionalidades Clave
* **Administración de Inventarios:** Registro, consulta y actualización de artículos en tiempo real.
* **Validaciones Dinámicas:** Implementación de alertas y validación de datos con JavaScript para evitar errores de usuario.
* **Persistencia de Datos:** Gestión eficiente de registros mediante consultas SQL optimizadas.
